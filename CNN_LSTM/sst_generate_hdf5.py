...
if __name__ == "__main__":
    ...
    w2v_file = "../dataset/SST_5/SST5.glove.to.TraceNet"
    h5_file = "../dataset/SST_5/sst5.hdf5"
    label_idx = {'__label__1': 0, '__label__2': 1, '__label__3': 2, '__label__4': 3, '__label__5': 4}
